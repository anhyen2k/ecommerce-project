...
@include('backend/generate/component/breadcrumb', ['title' => $config['seo']['delete']['title']])
        ...
        <div class="row">
            <div class="col-lg-5">
                ...
                <div class="panel-description">
                    <p> Bạn chắc chắn muốn bản ghi có tên là: {{ $generate->name }}</strong>. </p>
