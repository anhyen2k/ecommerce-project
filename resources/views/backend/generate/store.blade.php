@include('backend/generate/component/breadcrumb', ['title' => $config['seo']['create']['title']])
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input type="text" name="name"
                                        value="{{ old('name', $generate->name ?? '') }}" placeholder=""
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input type="text" name="canonical"
                                        value="{{ old('canonical', $generate->canonical ?? '') }}" placeholder=""
                                        autocomplete="off" class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input type="text" name="description"
                                        value="{{ old('description', $generate->description ?? '') }}" placeholder=""
                                        autocomplete="off" class="form-control">
                                </div>
                            </div>
                        </div>
