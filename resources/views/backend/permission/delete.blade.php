...
@include('backend/permission/component/breadcrumb', ['title' => $config['seo']['delete']['title']])
        ...
        <div class="row">
            <div class="col-lg-5">
                ...
                <div class="panel-description">
                    <p> Bạn chắc chắn muốn xóa Tiêu đề có tên là: {{ $permission->name }}</strong>. </p>
                        ...
                        <div class="row mb10">
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    type="text" 
                                    name="name"
                                    value="{{ old('email', ($permission->name) ?? '')}}"
                                    placeholder=""
                                    autocomplete="off"
                                    class="form-control">
                                </div>
