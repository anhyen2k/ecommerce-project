<table class="table table-striped table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="center"> {{ $userCatalogue->name }} </td>
            <td class="center"> {{ $userCatalogue->users_count }} người </td>
            <td class="center"> {{ $userCatalogue->description }} </td>
            <td class="text-center"> 
                <input type="checkbox" value="{{ $userCatalogue->publish }}" 
                class="js-switch status" data-field="publish" data-model="UserCatalogue" 
...
<div class="center">
    <div>{{ $userCatalogues->links('pagination::bootstrap-4') }}</div>
</div>